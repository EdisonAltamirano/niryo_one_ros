...
"""autogenerated by genpy from niryo_one_msgs/GetCalibrationCamRequest.msg. Do not edit."""
import sys
...
class GetCalibrationCamRequest(genpy.Message):
  _md5sum = "6aac6c697d5414bc0fcede8c33981d0e"
  _type = "niryo_one_msgs/GetCalibrationCamRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetCalibrationCamRequest, self).__init__(*args, **kwds)
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from niryo_one_msgs/GetCalibrationCamResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class GetCalibrationCamResponse(genpy.Message):
  _md5sum = "b839fe4c8d129bfa9bec199fe2fd8ec6"
  _type = "niryo_one_msgs/GetCalibrationCamResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """bool is_set
...
bool do_rectify
"""
  __slots__ = ['is_set','camera_info']
  _slot_types = ['bool','sensor_msgs/CameraInfo']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetCalibrationCamResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_B3I().pack(_x.is_set, _x.camera_info.header.seq, _x.camera_info.header.stamp.secs, _x.camera_info.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.is_set, _x.camera_info.header.seq, _x.camera_info.header.stamp.secs, _x.camera_info.header.stamp.nsecs,) = _get_struct_B3I().unpack(str[start:end])
      self.is_set = bool(self.is_set)
      start = end
      end += 4
...
def _get_struct_2I():
    ...
    return _struct_2I
class GetCalibrationCam(object):
  _type          = 'niryo_one_msgs/GetCalibrationCam'
  _md5sum = '474d4f7e9dcc435511068469b05fa0bb'
  _request_class  = GetCalibrationCamRequest
  _response_class = GetCalibrationCamResponse
